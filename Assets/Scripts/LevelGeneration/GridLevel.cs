...
public class GridLevel : MonoBehaviour, ILevel
{
    ...
    [SerializeField]
    int minNumberOfTIlesPerHeight = 2;
    [SerializeField]
    ...
    private void BuildLevel(Vector3 startPos, float currentHeight) 
    {
        ...
        xyTilesAtCurrentHeight[0] = startPos.x;
        ...
        zyTilesAtCurrentHeight[0] = startPos.z;
        for (int i = 1; i < numberOfTiles; i++)
    ...
    public void LoadLevel()
    {
        ...
        o.transform.localScale = new Vector3(2, 1, 2*maxDepth/20);
        Instantiate((GameObject)Resources.Load("LevelGenerator/JumpPad", typeof(GameObject)), Vector3.forward, Quaternion.Euler(0, 0, 0));
